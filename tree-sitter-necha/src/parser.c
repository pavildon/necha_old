...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fn_call_repeat1, 2), SHIFT_REPEAT(37),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_in_expr, 4, .production_id = 7),
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exprz, 1, .production_id = 6),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exprz, 1, .production_id = 5),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_in_expr, 5, .production_id = 8),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_def, 3, .production_id = 4),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expr, 2, .production_id = 1),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_let_expr_repeat1, 2), SHIFT_REPEAT(51),
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expr_repeat1, 2),
};
